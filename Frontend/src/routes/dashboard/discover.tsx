import { Search, ArrowRight, ArrowLeft, Globe, Code, Shield, PenTool, Database, LayoutTemplate } from 'lucide-react';
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-8">
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 mb-10 scrollbar-hide">
          {CATEGORIES.map((cat, idx) => (
            <button 
              key={idx}
              className="flex items-center gap-2 px-4 py-2 bg-gray-50 border border-gray-100 rounded-lg text-sm text-gray-600 whitespace-nowrap hover:bg-gray-100 transition-colors"
            >
              {cat.icon}
              {cat.name}
            </button>
        ...
        <div className="flex justify-center items-center gap-4 text-sm font-medium text-gray-500">
          ...
          <div className="flex items-center gap-2">
            <button className="w-8 h-8 flex items-center justify-center bg-[#0F1115] text-white rounded-lg">1</button>
            ...
            <button className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 rounded-lg">67</button>
            <button className="w-8 h-8 flex items-center justify-center hover:bg-gray-100 rounded-lg">68</button>
          </div>
