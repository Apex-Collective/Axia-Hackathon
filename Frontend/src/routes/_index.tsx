...
const TESTIMONIALS = [
  {
    ...
    content:
      "I spent years tweaking my CV and still felt invisible. Created my Apex profile in 8 minutes – got two recruiter messages the same week.",
    rating: 4.5,
    metric: "10x",
  ...
  },
  {
    ...
    content:
      "As a recruiter, I hate digging through attachments. Apex profiles are clean, fast to scan, and actually show real work. Game changer.",
    rating: 4.5,
    metric: "15x",
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Yep, 100% free! Creating your profile, publishing it, and sharing the link costs nothing – now or ever. We're keeping it simple and accessible for everyone.",
  },
  {
    question: "How long does it take to create a profile?",
    answer:
      "Most people wrap it up in under 10 minutes. The form is straightforward, just your basics, skills, and a quick bio.",
  },
  {
    question: "Do I need an account to start?",
    answer:
      "Not at all. Jump right in and start filling out your profile – no sign-up wall. We only ask for your email when you're ready to publish.",
  },
  {
    question: "Can I edit my profile later?",
    answer:
      "Absolutely, anytime. Just log back in with a quick magic link (no password hassle), tweak your skills, update links, or refresh your bio.",
  },
];
        ...
        <section className="px-4 mb-32 relative">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 mb-16">
            <div className="inline-flex items-center gap-2 bg-slate-100 border border-slate-200 rounded-full px-4 py-1.5 mb-8">
              ...
              <span className="text-sm font-medium text-slate-600">
                Create a clean, shareable profile that puts your skills front
                and center
              </span>
            </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10 px-4">
            ...
            <div className="group bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Guided form with smart suggestions. Add your name, bio, and
                links.
              </p>
            </div>
            ...
            <div className="group bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Let people know if you're actively looking, open to
                opportunities.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-12 mb-20 relative z-10">
            <Link
              to="/auth/signup"
              className="px-8 py-4 bg-slate-900 text-white rounded-xl font-medium text-lg hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20 hover:scale-105 flex items-center gap-2"
            >
              Create Profile Now
            </Link>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-10">
              {[
                ...
                <span
                  key={tag}
                  className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-medium text-slate-600 hover:border-slate-300 cursor-pointer"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900">
                What{" "}
                <span className="text-purple-600 bg-purple-50 px-2 rounded-lg">
                  Our Customers
                </span>{" "}
                Say
              </h2>
              <p className="mt-4 text-slate-500 max-w-lg mx-auto">
                Real stories from devs, designers, recruiters, and more who've
                made their skills impossible to miss.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              {TESTIMONIALS.map((item, idx) => (
                <div
                  key={idx}
                  className="bg-purple-50/50 rounded-3xl p-8 border border-purple-100"
                >
          ...
          <div className="max-w-3xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-slate-500">
                All the things you need to know about the ApexCollective
              </p>
            </div>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-sm max-w-sm leading-relaxed mb-8">
                Making the hiring process easier by putting the right talents in
                your face.
              </p>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs">
              © ApexCollective Inc. All Rights Reserved.
            </p>
            <button
          ...
          <div className="mt-20 opacity-5 select-none pointer-events-none">
            <h1 className="text-[12vw] font-bold text-center leading-none text-white tracking-tighter">
              ApexCollective
            </h1>
          </div>
        </div>
